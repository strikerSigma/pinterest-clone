...
const Nav = () => {
  return (
    ...
    <div className='nav mt-3 flex  md:space-x-10 p-4 lg:space-x-24'>
        ...
        <div className='  '>
            ...
            <div className='cursor-pointer h-12 w-18 p-3 rounded-full hover:bg-slate-200'>
                <Link href='/Create'>Create</Link></div></div>
  ...
  <input type="text" className="bg-transparent focus:outline-none ml-10 lg:mr-60 md:mr-20" placeholder="Search..." />
        ...
        <div className='flex lg:pl-10 space-x-10'>
        <div  className='pt-2 pl-5  cursor-pointer'><Image src="/bell.png" width={25} height={15} /></div>
